...
public class Skill_Base : MonoBehaviour
{
    ...
    public void SetSkillUpgrade(Skill_DataSO skilData)
    {
        UpgradeData upgrade = skilData.upgradeData;
        upgradeType = upgrade.upgradeType;
        cooldown = upgrade.cooldown;
        damageScaleData = upgrade.damageScaleData;

        player.ui.inGameUI.GetSkillSlot(skillType).SetupSkillSlot(skilData);
        ResetCooldown();
    }
