...
public class UI_SkillToolTip : UI_ToolTip
{
    ...
    [SerializeField] private string lockedSkillText = "You've taken a different path - this skill is now locked,be careful young man!";
    ...
    private string GetRequirements(int skillCost, UI_TreeNode[] neededNodes, UI_TreeNode[] conflictNodes)
    {
        ...
        foreach (var node in neededNodes)
        {
            ...
            string finalNodeText = GetColoredText(nodeColor, costText);
